...
This function generates a DMR matrix of state calls, rc.meth.lvls and posterior probabilities for all samples in one dataframe. You need to create a new folder for DMR matrix.
